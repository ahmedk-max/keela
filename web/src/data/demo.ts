...
const raw = {
  ...
  goals: [
    { id: 'g1', name: 'Emergency Fund', target: 50000, allocated: 38000, spent: 0, status: 'active', color: '#C4623A', targetDate: '2026-12', note: 'Six months of runway. Keep feeding it before anything fun.' },
    { id: 'g2', name: 'New Car', target: 80000, allocated: 24000, spent: 0, status: 'active', color: '#A05F1A', targetDate: '2027-06', note: '' },
    { id: 'g3', name: 'Japan Trip', target: 15000, allocated: 15000, spent: 8200, status: 'completed', color: '#5D3D2E', targetDate: '2026-04', note: 'Funded and underway — drawing it down.' },
    { id: 'g4', name: 'MacBook Pro', target: 9000, allocated: 9000, spent: 0, status: 'completed', color: '#C99A52', targetDate: '2026-03', note: '' },
    { id: 'g5', name: 'Wedding', target: 120000, allocated: 12000, spent: 0, status: 'paused', color: '#BEB6A3', targetDate: '2027-10', note: 'On hold until the car is done.' },
  ],
  portfolios: [
    { id: 'pf1', name: 'Long-term', target: 200000, targetDate: '2027-10', color: '#A05F1A', note: 'Buy-and-hold core. Index funds and gold — the slow, boring compounding.' },
    { id: 'pf2', name: 'Speculative', target: 20000, targetDate: '2027-01', color: '#5D3D2E', note: 'Play money. Capped — never feed it more than it earns back.' },
    { id: 'pf3', name: 'Cash', target: 50000, targetDate: '2026-12', color: '#BEB6A3', note: 'Dry powder for opportunities.' },
  ],
  assets: [
    // cost basis = allocated; avg cost = allocated / units
    { id: 'a1', name: 'US Stocks (VOO)', portfolioId: 'pf1', kind: 'position', category: 'stocks', units: 80, allocated: 30000, color: '#A05F1A' },
    { id: 'a2', name: 'Gold', portfolioId: 'pf1', kind: 'position', category: 'commodity', units: 60, allocated: 12000, color: '#C99A52' },
    { id: 'a3', name: 'Bitcoin', portfolioId: 'pf2', kind: 'position', category: 'crypto', units: 0.04, allocated: 8000, color: '#5D3D2E' },
    { id: 'a4', name: 'Cash Reserve', portfolioId: 'pf3', kind: 'cash', category: 'cash', units: null, allocated: 20000, color: '#BEB6A3' },
  ],
  wishlist: [
